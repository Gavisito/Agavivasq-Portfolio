    ...
    <Navbar className="navigation" fixed="top" expand="sm">
      <>
        ...
        <Nav className={`nav ${isMenuOpen ? 'active' : ''}`}>
          ...
          <Nav.Link as={Link} to="art" duration={350} smooth={true} offset={-90} className="nav-link" onClick={handleNavLinkClick}>Art Projects</Nav.Link>
          <Nav.Link as={Link} to="webapps" duration={350} smooth={true} offset={-90} className="nav-link" onClick={handleNavLinkClick}>Web Projects</Nav.Link>
