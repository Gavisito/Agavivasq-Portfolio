...
const Navigation: React.FC = () => {
  const toggleActive = (): void => {
    const hamburger = document.querySelector<HTMLElement>(".ham-icon");
    ...
    <div>
      <Navbar className="navigation" fixed="top" expand="sm">
        <div className="branding">
          <div><a href="#home" className="company-logo"><img src="/public/agavivasq.ico" className="gavipic" /></a></div>
